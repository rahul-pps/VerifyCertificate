...
import { getCertificateData } from '../../lib/sheets';  // << correct path
...
export default async function CertificatePage({ params }) {
  headers(); // ensure no-store at edge (best effort)
  const certId = params.certId;
  const data = await getCertificateData(certId);
